...
if(form.prompt){
  try {
    ...
    const response = await fetch('https://dall-e-8byo.onrender.com/api/v1/dalle',{
      method: 'POST',
      headers: {
...
if(form.prompt && form.photo){
 ...
 try {
  const response = await fetch('https://dall-e-8byo.onrender.com/api/v1/post',{
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
    },
...
setForm({...form, prompt: randomPrompt})
  ...
  return (
   ...
   Create
      ...
      <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'>Create of imaginative and visually stunning images through DALL-E AI and share them with the community</p>
    </div>
